...
{
    public PT_XMLReader01 xmlr; //Just like the Deck, this has a PT_XMLReader
    public PT_XMLHashtable01 xml; //This variable is for faster xml access
    ...
    public void ReadLayout(string xmlText)
    {
        ...
        PT_XMLHashList01 slotsX = xml["slot"];
